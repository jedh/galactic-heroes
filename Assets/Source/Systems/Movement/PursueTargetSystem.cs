...
namespace GH.Systems
{
    ...
    public class PursueTargetSystem : JobComponentSystem
    {
        ...
        private float m_LookAheadTimeStep = .5f;
        ...
        struct BeginPursuitJob : IJobForEachWithEntity<Target, WeaponStats, MovementStats, DeployToPosition>
        {
            ...
            public void Execute(Entity entity, int index, [ReadOnly] ref Target target, [ReadOnly] ref WeaponStats weaponStats, [ReadOnly] ref MovementStats movementStats, ref DeployToPosition deployToPosition)
            {
                ...
                var desiredPosition = targetPosition.Value + targetVelocity.Value * LookAheadTimeStep;
        ...
        struct UpdatePursuitJob : IJobForEachWithEntity<Target, DeployToPosition, Translation, CombatMovement, PursueTarget>
        {
            [ReadOnly]
            public ComponentDataFromEntity<Translation> TranslationData;
            ...
            public void Execute(Entity entity, int index, [ReadOnly] ref Target target, ref DeployToPosition deployToPosition, [ReadOnly] ref Translation translation, [ReadOnly] ref CombatMovement combatMovement, [ReadOnly] ref PursueTarget pursueTarget)
            {
